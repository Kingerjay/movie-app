...
function Sectionone() {
    ...
    const trendMovie = async () => {
        try {
            ...
            setResponses(res.data.results.slice(0, 3));
        } catch (error) {
            setIsLoading(false)
  ...
  return (
    ...
    <div className='w-[80%] mx-auto my-16 '>
        ...
        <p className=''><a href="/trending" className='flex items-center gap-2 text-[24px] font-semibold opacity-[50%]'>view all <GoArrowRight /></a> </p>
        </div>
        {/* End of Top text */}
    ...
    <div className='grid grid-cols-1 md:grid-cols-3 sm:grid-cols-2 justify-between gap-x-8 gap-y-12 transition transform ease-in-out duration-500'>
