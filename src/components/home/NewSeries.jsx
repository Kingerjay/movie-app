...
function NewSeries() {
    ...
    const trendMovie = async () => {
        try {
            ...
            setResponses(res.data.results.slice(0, 4));
        } catch (error) {
            setIsLoading(false)
  ...
  return (
    ...
    <div className='w-[80%] mx-auto my-16 '>
        ...
        <p className=''><a href="/newseriestv" className='flex items-center gap-2 text-[24px] font-semibold opacity-[50%]'>view all <GoArrowRight /></a> </p>
        </div>
        {/* End of Top text */}
