    ...
    return (
        <div className="w-[80%] mx-auto my-16">
            ...
            {isLoading ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-5 sm:grid-cols-2 sm:gap-x-12 sm:justify-between gap-y-12 md:gap-x-48 ">
                    ...
                    <div className='w-[88px] h-[88px] border-[1px] rounded-full grid place-items-center bg-[rgba(217,217,217,1)]'>
            <a href="/recently"><GoArrowRight className=' text-black text-[50px] font-semibold'/></a>
        </div>
