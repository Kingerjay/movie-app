...
function Recommend() {
  ...
  return (
    ...
    <div className='w-[80%] mx-auto my-20 '>
        ...
        <div>
        <p className=''><a href="/recommends" className='w-full flex justify-end items-center gap-2 text-[24px] font-semibold opacity-[50%] whitespace-nowrap overflow-hidden'></a> </p>
        </div>
